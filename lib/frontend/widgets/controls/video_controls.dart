...
// /// [VideoControlsThemeData] available in this [context].
...
//             kDefaultVideoControlsThemeDataFullscreen;

// /// Default [VideoControlsThemeData].
// const kDefaultVideoControlsThemeData = VideoControlsThemeData();

// /// Default [VideoControlsThemeData] for fullscreen.
// const kDefaultVideoControlsThemeDataFullscreen = VideoControlsThemeData(
//   displaySeekBar: true,
...
//     SkipPreviousButton(),
//     Spacer(),
//     PlayOrPauseButton(iconSize: 56.0),
//     Spacer(),
//     SkipNextButton(),
//     Spacer(flex: 2),
//   ],
...
// /// {@template _video_controls_theme_data}
// ///
// /// Theming related data for [VideoControls]. These values are used to theme the descendant [VideoControls].
// ///
// /// {@endtemplate}
...
//   /// {@macro _video_controls_theme_data}
...
//   /// Creates a copy of this [VideoControlsThemeData] with the given fields replaced by the non-null parameter values.
//   VideoControlsThemeData copyWith({
//     bool? displaySeekBar,
...
// /// {@template _video_controls_theme}
// ///
// /// Inherited widget which provides [VideoControlsThemeData] to descendant widgets.
// ///
// /// {@endtemplate}
...
//     assert(
//       result != null,
//       'No [VideoControlsTheme] found in [context]',
//     );
//     return result!;
//   }
...
// /// {@template _video_controls}
// ///
// /// [Video] controls which use  design.
// ///
// /// {@endtemplate}
...
//     _timer?.cancel();
//     _timer = Timer(
//       const Duration(seconds: 5), // Fixed 5 second duration
//       () {
//         if (mounted) {
//           setState(() {
//             visible = false;
...
//     return renderBox.paintBounds.width;
//   }
...
//       focusNode: FocusNode(canRequestFocus: _fakeFocusActive),
...
//                                 child: Focus(
//                                   onFocusChange: (_) => onFocusChanged(),
//                                   child: Row(
...
// /// A  design play/pause button.
// class PlayOrPauseButton extends StatefulWidget {
//   /// Overriden icon size for [SkipPreviousButton].
//   final double? iconSize;

//   /// Overriden icon color for [SkipPreviousButton].
...
// ///  design skip next button.
// class SkipNextButton extends StatelessWidget {
//   /// Icon for [SkipNextButton].
//   final Widget? icon;

//   /// Overriden icon size for [SkipNextButton].
//   final double? iconSize;

//   /// Overriden icon color for [SkipNextButton].
//   final Color? iconColor;
...
// ///  design skip previous button.
// class SkipPreviousButton extends StatelessWidget {
//   /// Icon for [SkipPreviousButton].
//   final Widget? icon;
...
// ///  design fullscreen button.
// class FullscreenButton extends StatelessWidget {
//   /// Icon for [FullscreenButton].
//   final Widget? icon;

//   /// Overriden icon size for [FullscreenButton].
//   final double? iconSize;

//   /// Overriden icon color for [FullscreenButton].
//   final Color? iconColor;
...
//   /// Icon for [CustomButton].
//   final Widget? icon;

//   /// Icon size for [CustomButton].
//   final double? iconSize;

//   /// Icon color for [CustomButton].
//   final Color? iconColor;
...
//   /// Overriden [TextStyle] for the [PositionIndicator].
//   final TextStyle? style;
//   const PositionIndicator({super.key, this.style});

//   @override
//   PositionIndicatorState createState() => PositionIndicatorState();
// }
...
//   /// Builds the [PositionIndicator] widget.
//   ///
//   /// The [PositionIndicator] shows the current position of the video in a
//   /// [Text] widget. The text is formatted to show the position in the format
//   /// "HH:MM:SS / HH:MM:SS".
//   ///
//   /// If a [TextStyle] is provided in the constructor, it will be used to style
//   /// the text. Otherwise, the default style will be used. The default style is
//   /// a 12pt font with a height of 1.0 and a color of
//   /// [_theme(context).buttonBarButtonColor].
//   ///
//   /// This widget is typically used in the [appBar] of a [Scaffold] to show the
//   /// video position.
//   Widget build(BuildContext context) {
//     return Text(
